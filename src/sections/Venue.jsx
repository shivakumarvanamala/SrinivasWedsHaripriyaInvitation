  ...
  return (
    <section id="venue" className="section-pad relative bg-plum-deep-radial jali">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h2 className="mt-3 font-heading text-3xl text-foil md:text-5xl">{t(ui.venueHeading)}</h2>
          ...
          <div className="p-7">
            ...
            {venue.directionsUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-block rounded-full bg-gold-gradient px-6 py-2.5 font-heading tracking-widest text-plum-deep shadow-glow transition hover:scale-105"
              >
                {t(ui.directions)}
              </a>
            )}
